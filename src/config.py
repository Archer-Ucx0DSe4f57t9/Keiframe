...
MALWARFARE_PURIFIED_COUNT_TOP_LEFT_COORD = (306, 165)
...
BASE_RESOLUTION_WIDTH = 1936.0 # 基准分辨率宽度(窗口模式下的1920)

# 模板文件夹的相对路径
MALWARFARE_TEMPLATE_DIR = 'char_templates_1936w' # 建议与基准分辨率匹配

# 各ROI相对于Count区域左上角的偏移量 (请替换为您在第二步中计算出的值)
MALWARFARE_TIME_OFFSET_FROM_COUNT = (133, 1)    # 示例: (439-306, 165-164)
MALWARFARE_PAUSED_OFFSET_FROM_COUNT = (45, 1)   # 示例: (351-306, 165-164)
