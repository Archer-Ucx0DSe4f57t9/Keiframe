...
MALWARFARE_TIME_TOP_LFET_COORD = (436,162)
MALWARFARE_TIME_BOTTOM_RIGHT_COORD = (482,186)

MALWARFARE_PAUSED_TOP_LFET_COORD = (352, 166)
MALWARFARE_PAUSED_BOTTOM_RIGHT_COORD =(429, 183)

MALWARFARE_PURIFIED_COUNT_TOP_LEFT_COORD = (305, 165)
MALWARFARE_PURIFIED_COUNT_BOTTOMRIGHT_COORD = (341, 183)
